          ...
          <div class="card-body mx-5 my-3">
            ...
            <form action="<?= base_url('admin/kelas'); ?>" method="post">
              ...
              <div class="form-group mt-4">
                ...
                <input type="text" id="kelas" class="form-control <?= $validation->getError('kelas') ? 'is-invalid' : ''; ?>" name="kelas" placeholder="Tingkat 1" , value="<?= old('kelas') ?? $oldInput['kelas']  ?? '' ?>" required>
