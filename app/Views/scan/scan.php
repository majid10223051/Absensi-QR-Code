             ...
             <div class="col-lg-6 col-xl-4">
                <div class="card">
                   <div class="col-10 mx-auto card-header card-header-primary">
                      <div class="row">
                         <div class="col">
                            <h4 class="card-title"><b>Kehadiran <?= $waktu; ?></b></h4>
             ...
             <div class="col-lg-3 col-xl-4">
                <div class="card">
                   <div class="card-body">
                      ...
                      <ul class="pl-3">
                         <li>Jika berhasil scan maka akan muncul data mahasiswa/dosen dibawah preview kamera</li>
                         <li>Untuk melihat data , klik tombol <span class="text-primary"><i class="material-icons" style="font-size: 16px;">dashboard</i> Dashboard Petugas</span></li>
